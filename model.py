...
def get_globals():
    from code_files.config import a, b, c, d, e, f, g, h, i
    ...
    return vocab_size, out_space, ncol, n_embd, n_head, n_layer, dropout, device, width


class Head(nn.Module):
    def __init__(self, head_size):
        super().__init__()
        vocab_size, out_space, ncol, n_embd, n_head, n_layer, dropout, device, width = get_globals()
...
class FeedForward(nn.Module):
    def __init__(self, n_embd):
        ...
        self.net = nn.Sequential(
            nn.Linear(n_embd, int(width * n_embd)),
            nn.ReLU(),
            nn.Linear(int(width * n_embd), n_embd),
            nn.Dropout(dropout)
        )
